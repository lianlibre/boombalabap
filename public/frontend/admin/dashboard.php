...
$non_teaching  = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'non_teaching'")->fetch_row()[0];
$dept_heads    = $conn->query("SELECT COUNT(*) FROM users WHERE role LIKE 'dept_head_%'")->fetch_row()[0];
$school_counselor = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'school_counselor'")->fetch_row()[0];
$library       = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'library'")->fetch_row()[0];
$soa           = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'soa'")->fetch_row()[0];
$guidance      = $conn->query("SELECT COUNT(*) FROM users WHERE role = 'guidance'")->fetch_row()[0];
